...
const collection = client.db("spotifier").collection<TrackItemWithAudioFeatures>("tracks")

export async function getCachedTracks(track_ids: string[]): Promise<TrackItemWithAudioFeatures[]> {
